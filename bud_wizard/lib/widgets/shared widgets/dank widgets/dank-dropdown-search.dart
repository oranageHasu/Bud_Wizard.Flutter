import 'dart:async';
import 'package:bud_wizard/widgets/shared%20widgets/dank%20widgets/dank-dropdown-dialog.dart';
import 'package:bud_wizard/widgets/shared%20widgets/dank%20widgets/dank-dropdown-popup-menu.dart';
...
class DankDropdownSearch<T> extends StatefulWidget {
  ...
  @override
  DankDropdownSearchState<T> createState() => DankDropdownSearchState<T>();
}

class DankDropdownSearchState<T> extends State<DankDropdownSearch<T>> {
  ...
  DankDropdownDialog<T> _selectDialogInstance(T data, {double defaultHeight}) {
    return DankDropdownDialog<T>(
