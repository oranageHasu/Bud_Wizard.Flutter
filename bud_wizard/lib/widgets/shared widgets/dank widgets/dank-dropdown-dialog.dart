...
import 'package:bud_wizard/widgets/shared%20widgets/dank%20widgets/dank-dropdown-search.dart';
import 'package:flutter/material.dart';

class DankDropdownDialog<T> extends StatefulWidget {
  ...
  @override
  _DankDropdownDialogState<T> createState() => _DankDropdownDialogState<T>();
}

class _DankDropdownDialogState<T> extends State<DankDropdownDialog<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    double maxHeight = deviceSize.height * (isTablet ? .6 : .6);
