...
docker tag danksolutions/budwizard registry.digitalocean.com/bud-wizard-image-repo/budwizard-test:1.0.12

echo Step 3) Push the Docker images we just created to Docker Hub
docker push registry.digitalocean.com/bud-wizard-image-repo/budwizard-test:1.0.12
